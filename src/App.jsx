  ...
  const phases = [
    {
      label: "Phase One",
      trigger: "Now",
      name: "Build Your Mind",
      description: "Sign up, start talking, and watch your digital mind take shape. Ether learns how you think through natural conversations that get deeper over time. Save memories, see your mind map grow, and build something that lasts.",
      milestones: [
    ...
    },
    {
      ...
      trigger: "Next",
      name: "Bring It Alive",
      description: "Your Ether stops being data and starts being you. See yourself, hear yourself — a digital version that looks and sounds like the real thing.",
      milestones: [
    ...
    },
    {
      ...
      description: "The people you love get access to everything you've built. Your intelligence stays in the family — and if you choose, the world.",
      milestones: [
